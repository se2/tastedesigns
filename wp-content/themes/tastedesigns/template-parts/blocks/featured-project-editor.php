  ...
  <section class="c-featured-project w-full relative pt-30 pb-80 lg:py-80">
    <div class="c-featured-project__inner flex flex-col lg:flex-row">
      ...
      <div class="c-featured-project__content w-full lg:w-34% px-20 lg:px-50">
        <h2 class="font-title text-42 leading-57 text-taste-4 hidden lg:block" <?php $colors->getTertiary(); ?>>
          Featured Project
        </h2>
        <?php if (get_field('location')) : ?>
          <h3 class="font-subtitle text-14 leading-21 tracking-3.71 lg:text-16 lg:leading-24 lg:tracking-4.24 text-taste-2 uppercase mt-30 lg:mt-45" <?php $colors->getPrimary(); ?>>
            <?php the_field('location'); ?>
          </h3>
        <?php endif; ?>
        <h1 class="font-title text-42 leading-57 lg:text-66 lg:leading-89 text-taste-1 break-words" <?php $colors->getPrimary(); ?>>
          <?php the_title(); ?>
        </h1>
        ...
        <?php if (have_rows('partners')) : ?>
          <h3 class="font-subtitle text-14 leading-21 tracking-3.71 lg:text-16 lg:leading-24 lg:tracking-4.24 text-taste-2 uppercase mt-40 lg:mt-30" <?php $colors->getPrimary(); ?>>
            Project Partners
          </h3>
