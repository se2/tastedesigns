...
if (have_rows('press')) : ?>
  <div class="c-team w-full py-60 lg:py-80">
    <h1 class="font-title text-42 leading-57 lg:text-58 lg:leading-78 mb-50 xl:mb-0 text-taste-1 text-center lowercase" <?php $colors->getPrimary(); ?>>
      <?php echo $title; ?>
    </h1>
        ...
        <div class="c-team__item w-full lg:w-1/3 px-0 lg:px-6 lg:py-24">
          ...
          <?php endif; ?>
            ...
            >
              ...
              <h1 class="font-title text-42 leading-57 text-taste-1 text-center mt-20" <?php $colors->getPrimary(); ?>>
                <?php the_sub_field('title'); ?>
              </h1>
              <h2 class="font-subtitle text-14 leading-30 tracking-3.71 lg:text-16 lg:leading-30 lg:tracking-4.24 text-taste-2 uppercase text-center no-underline" <?php $colors->getSecondary(); ?>>
