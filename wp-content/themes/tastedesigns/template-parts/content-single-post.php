...
<section class="c-blog">
  ...
  <div class="c-blog__header lg:px-50 js-header-blog">
    <h1 class="c-blog__title font-title text-center text-taste-1 text-42 leading-57 lg:text-58 lg:leading-78 mt-20 lg:mt-0 lowercase <?php echo $alter ? 'pb-40 lg:pb-60' : ''; ?>" <?php $theme_colors->getPrimary(); ?>>
  ...
  <article id="post-<?php the_ID(); ?>" <?php post_class('c-single-post min-h-full w-full' . $post_class); ?> >
    ...
    <div class="c-blog__content pt-50 lg:pt-60 pb-70 lg:pb-140 <?php if (!$alter) : echo 'max-w-1000'; endif; ?> mx-auto border-b-2 border-taste-5 lg:border-b-0">
      <div class="c-blog__inner mx-20 lg:mx-0">
        ...
        <h1 class="c-blog__title font-title text-taste-1 text-42 leading-57 lg:text-58 lg:leading-78 text-center <?php if ($alter) : ?>lg:text-left<?php endif; ?>">
          <?php the_title(); ?>
        </h1>
