...
<div class="c-header js-header-blog pb-1">
	<h1 class="c-page__title font-title text-center text-taste-1 text-42 leading-57 lg:text-66 lg:leading-89 mt-20 xl:mt-0 lowercase mb-40 lg:mb-60" <?php $theme_colors->getPrimaryColor(); ?>><?php echo get_the_title(get_option('page_for_posts', true)); ?></h1>
