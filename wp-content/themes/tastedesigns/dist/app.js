...
/* harmony default export */ __webpack_exports__["a"] = ({
  ...
  initCommon: function initCommon() {
    ...
    e.$window = __WEBPACK_IMPORTED_MODULE_0_jquery___default()(window);
    e.$menu = __WEBPACK_IMPORTED_MODULE_0_jquery___default()('.js-menu');
    e.$menuDecoy = __WEBPACK_IMPORTED_MODULE_0_jquery___default()('.js-menu-decoy');
    e.$menuTrigger = __WEBPACK_IMPORTED_MODULE_0_jquery___default()('.js-menu-trigger');
    e.$submenu = __WEBPACK_IMPORTED_MODULE_0_jquery___default()('.menu-item-has-children');
    e.$submenuLink = __WEBPACK_IMPORTED_MODULE_0_jquery___default()('.menu-item-has-children > a');
    e.$searchTrigger = __WEBPACK_IMPORTED_MODULE_0_jquery___default()('.js-search-trigger');
    e.$searchClose = __WEBPACK_IMPORTED_MODULE_0_jquery___default()('.js-search-close');
    e.$searchForm = __WEBPACK_IMPORTED_MODULE_0_jquery___default()('.js-search-form');
    e.$searchInput = __WEBPACK_IMPORTED_MODULE_0_jquery___default()('.js-search-input');
  },
  initMenu: function initMenu() {
    ...
    e.$submenuLink.click(function (event) {
      ...
      var minHeight = $link.outerHeight();

      if ($link.hasClass('is-active')) {
        $menu.css('height', minHeight);
        $link.removeClass('is-active');
      } else {
        var $childMenu = $menu.children('.sub-menu');
        var maxHeight = minHeight + $childMenu.outerHeight();
...
/* harmony default export */ __webpack_exports__["a"] = ({
  ...
  initHome: function initHome() {
    ...
    e.$window = __WEBPACK_IMPORTED_MODULE_0_jquery___default()(window);
    e.$root = __WEBPACK_IMPORTED_MODULE_0_jquery___default()('html, body');
    e.$scroll = __WEBPACK_IMPORTED_MODULE_0_jquery___default()('.js-scroll');
    e.$gallery = __WEBPACK_IMPORTED_MODULE_0_jquery___default()('.js-project-gallery');
    e.$galleryItem = __WEBPACK_IMPORTED_MODULE_0_jquery___default()('.js-project-gallery-item');
  },
  initCover: function initCover() {
    var s = this;
    var e = s.elements;

    e.$scroll.click(function () {
      var height = e.$window.height();
  ...
  initFeaturedProject: function initFeaturedProject() {
    var s = this;
    var e = s.elements;
