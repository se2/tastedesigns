...
<div id="page" class="site w-full h-full">
	...
	<header id="masthead" class="site-header">
		<div class="site-branding absolute w-full z-50 pt-40 pb-40 pl-50 pr-50">
			...
			if ( is_front_page() && is_home() ) :
				...
				<div class="c-menu float-right">
					<a href="#" class="c-menu__item font-body text-body-size leading-body tracking-body text-light uppercase no-underline">
						Work With Us
					...
					<a href="#" class="c-menu__item font-body text-body-size leading-body tracking-body text-light uppercase no-underline ml-85 js-menu-trigger">
						Menu
		...
		<nav id="site-navigation" class="c-main-menu__wrapper js-menu main-navigation absolute z-50 bg-light h-full right-0 pt-40 pb-40 pl-50 pr-50">
			...
			<div class="c-menu float-right">
				<a href="#" class="c-menu__item font-body text-body-size leading-body tracking-3.71 text-taste-1 uppercase no-underline">Work With Taste</a>
				<div class="c-menu__separator w-2 h-36 bg-taste-5 opacity-80 inline-block align-middle ml-28 mr-28"></div>
				<a href="#" class="c-menu__item font-body text-body-size leading-body tracking-body text-taste-3 uppercase no-underline">
					Search
				...
				<div class="c-menu__separator w-2 h-36 bg-taste-5 opacity-80 inline-block align-middle ml-28 mr-28"></div>
				<a href="#" class="c-menu__item font-body text-body-size leading-body tracking-body text-taste-3 uppercase no-underline js-menu-trigger">
					Menu
